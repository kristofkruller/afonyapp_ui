...
import type { Crop } from "@/store/crops/types";
...
/**
 * Orders component displays a list of crops as virtual avaliable product pool with their status and actions.
 * Only reachable on admin scope, they can filter cancel or update the crop pool.
 * @param {CropsProps} { crops } - The list of crops to display.
 */
export const Crops = ({ crops }: CropsProps) => {
  ...
  /**
   * Displays a confirmation pop-up for canceling a crop pool.
   * @param {Crop} crop - The crop pool to be canceled.
   */
